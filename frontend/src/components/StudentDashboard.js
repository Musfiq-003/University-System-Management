      ...
      <div className="dashboard-grid">
        ...
        <div className="dashboard-widget actions-widget">
          ...
          <div className="actions-grid">
            <button className="quick-action-card blue" onClick={() => navigate('/routines')}>
              <div className="action-icon">📅</div>
              <span>View Routine</span>
            </button>
            <button className="quick-action-card green" onClick={() => navigate('/hostel')}>
              <div className="action-icon">🏠</div>
              <span>Hostel Request</span>
            </button>
            <button className="quick-action-card purple" onClick={() => navigate('/research-papers')}>
              <div className="action-icon">📄</div>
              <span>Submit Paper</span>
            </button>
            <button className="quick-action-card orange" onClick={() => navigate('/teachers')}>
              <div className="action-icon">👨‍🏫</div>
              <span>Faculty List</span>
            </button>
            <button className="quick-action-card red" onClick={() => alert('Progress tracking feature coming soon!')}>
              <div className="action-icon">📊</div>
              <span>My Progress</span>
            </button>
            <button className="quick-action-card teal" onClick={() => alert('Messages feature coming soon!')}>
